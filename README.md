...
A web app for building the **awards-ceremony slideshow** for Destination Imagination (DI) tournaments. A user uploads the results export (CSV) from the DI Scoring Program, optionally uploads related asset files and a special-awards export, configures a few options, and the app generates a slideshow announcing the winners.
...
AwardsGen is not affiliated with or endorsed by Destination Imagination, Inc.
...
- Remember it is licensed under **AGPL-3.0** (see [License](#license)) — among other things, if you host a modified version, you must make your source available.
...
Copyright (C) 2026 T. Dustin Loftis.

## Contact / attribution

Created and maintained by **T. Dustin Loftis** — TXCPSO, Southeast 6 Region.
Email: **dustin.loftis@ditxse6.org**
